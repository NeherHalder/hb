			...
			<div class="header-site-info" id="header-site-info">
				<div>
					...
					<div class="clearfix" id="site-name-wrapper">
						<span id="site-name"><a title="Home" href="http://www.publiclibrary.gov.bd">{{ __('frontendnav.title') }}</a></span>
						<span id="slogan"></span>
					</div>
					<!-- /site-name-wrapper -->
			...
			<div role="navigation" id="dawgdrops">
				<ul class="meganizr mzr-slide mzr-responsive">
					...
					<li class="col1 mzr-drop">
						<a href="{{ url('booking-rooms') }}" class="submenu">{{ language('Venues & Services', 'ভেন্যু ও সেবা') }}</a>
					</li>
					<li class="col5 mzr-drop">
						<a href="#" class="submenu">{{ language('Booking Rules', 'বুকিংয়ের নীতিমালা') }}</a>
						<div class="mzr-content drop-one-columns">
							<div class="one-col"><h6></h6>
								<ul class="mzr-links">
									<li>
					...
					<li class="col2 mzr-drop">
						<a href="{{ url('booking-calendar') }}" class="submenu">
							{{ language('Booking Calendar', 'বুকিং ক্যালেন্ডার') }}
						</a>
					</li>
					<li class="col3 mzr-drop">
						<a href="{{ url('contact') }}" class="submenu">{{ __('frontendnav.contact') }}</a>
					</li>
				</ul>	
			</div>
		</div>    
